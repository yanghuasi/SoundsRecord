...
public class PlaybackFragment extends DialogFragment {
    ...
    public PlaybackFragment newInstance(DataEntity item) {
        PlaybackFragment f = new PlaybackFragment();
        Bundle b = new Bundle();
//        b.putParcelable(ARG_ITEM, (Parcelable) item);
//        b.putStringArrayList("entity",item);
...
//        item = getArguments().getStringArrayList("entity");
//        Bundle b = getArguments();
//        item  = b.getParcelable(ARG_ITEM);

        item =  getArguments().getParcelable(ARG_ITEM);
        long itemDuration = (long) item.getLength();
